...
describe('AppFrame', () => {
  it('exposes stable Neonforge markers on the frame and column slots', () => {
    const { frame, getByTestId } = mountFrame()
    expect(frame.hasAttribute('data-neonforge-frame')).toBe(true)
    expect(getByTestId('center-content').parentElement?.hasAttribute('data-neonforge-conversation')).toBe(true)
    expect(getByTestId('details-content').parentElement?.hasAttribute('data-neonforge-details')).toBe(true)
  })
