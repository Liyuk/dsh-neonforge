          ...
          <div className={css.tools}>
            <Tooltip label={t('input.commands')} side="top" delayMs={500}>
              <button
                type="button"
                className={css.add}
                data-neonforge-composer-control
          ...
          <div className={css.trailing}>
            ...
            <Tooltip label={primaryLabel} side="top" delayMs={500}>
              <button
                type="button"
                className={css.primary}
                data-neonforge-composer-button
                data-neonforge-stop-button={primaryStops || undefined}
                data-neonforge-send-button={!primaryStops || undefined}
