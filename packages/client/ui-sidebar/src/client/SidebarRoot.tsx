...
export function SidebarRoot({
  ...
  return (
    <div
      ...
      data-neonforge-sidebar-shell
      data-neonforge-sidebar-mode={wide ? 'wide' : 'rail'}
    ...
    >
      <div className={css.logoRow} data-neonforge-sidebar-logo>
      ...
      <div className={css.footArea} data-neonforge-sidebar-footer>
